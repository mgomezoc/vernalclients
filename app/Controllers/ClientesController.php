...
class ClientesController extends BaseController
{
    ...
    public function abogado()
    {
        ...
        $data['scripts'] = [
            ...
            "<script src='https://cdn.tiny.cloud/1/qk8yw46f1bd42uiso9i2v43nlv51myw0gq5f8th9cl905hcl/tinymce/7/tinymce.min.js'></script>",
    ...
    public function verCliente($idCliente)
    {
        ...
        $data["styles"] .= '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/select2-bootstrap-5-theme@1.3.0/dist/select2-bootstrap-5-theme.min.css">';
        $data["styles"] .= '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">';
        $data["styles"] .= '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fancyapps/ui@5.0/dist/fancybox/fancybox.css">';
        ...
        $data['scripts'] .= "<script src='https://cdn.jsdelivr.net/npm/flatpickr'></script>";
        $data['scripts'] .= "<script src='https://cdn.tiny.cloud/1/qk8yw46f1bd42uiso9i2v43nlv51myw0gq5f8th9cl905hcl/tinymce/7/tinymce.min.js'></script>";
