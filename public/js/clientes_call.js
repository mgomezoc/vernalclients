 ...
 */
const urls = {
    obtener: baseUrl + 'clientes/callcenter/obtener',
    ...
    if (navigator.clipboard) {
        navigator.clipboard
            ...
            .then(function () {
                ...
                showToast('Texto copiado al portapapeles', 'success'); // Mostrar un toast o un mensaje para el usuario
            })
            .catch(function (err) {
                console.error('No se pudo copiar el texto: ', err);
                showToast('No se pudo copiar el texto', 'error'); // Mostrar un toast o un mensaje para el usuario
            });
    } else {
...
function fallbackCopyToClipboard(text) {
    ...
    textArea.value = text;
    textArea.style.position = 'fixed'; // Evitar que el textarea se desplace de la vista
    ...
    try {
        ...
        console.log(msg);
        showToast(msg, successful ? 'success' : 'error'); // Mostrar un toast o un mensaje para el usuario
    } catch (err) {
        console.error('No se pudo copiar el texto: ', err);
        showToast('No se pudo copiar el texto', 'error'); // Mostrar un toast o un mensaje para el usuario
    }
